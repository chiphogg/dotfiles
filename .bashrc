...
# Keep EDITOR as a single token so tools that do naive whitespace splits (e.g.
# Claude Code's Ctrl-G) don't misparse it.  The nvim-unception blocking flag
# is set in ~/.config/nvim/init.lua instead.
export EDITOR="nvim"
